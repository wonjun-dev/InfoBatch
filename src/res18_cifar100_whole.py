...
def run_train():
    ...
    for epoch in range(config.num_epochs):
        ...
        mlflow.log_metrics({'train_loss': train_loss / len(train_loader), 
                            ...
                            'train_duration': train_duration}, step=epoch)
...
if __name__ == "__main__":
    ...
    train_dataset = datasets.CIFAR100(root='/sources/dataset/cifar100', train=True, download=True, transform=train_tranform)
    ...
    train_criterion = nn.CrossEntropyLoss(label_smoothing=config.label_smooth)
    ...
    # mlflow setting
    mlflow.set_experiment('R18_CIFAR100_Whole')
    mlflow.start_run()
